        ...
        <Grid container direction='column'>
            ...
            >
                ...
                <Grid item container justifyContent={matchesMD ? 'center' : 'flex-end'} lg>
                    <Lottie options={defaultOptions} style={{maxWidth: '40em', nargin: 0}}/>
                </Grid>
            </Grid>
            {/*-----Process----- */}
            ...
            >
                ...
                <Grid item lg style={{alignSelf: 'center'}}>
                    <img src={mockup} alt='basic website design outlin' width='100%' style={{maxWidth: 1000}} />
                </Grid>
            </Grid>
            {/*-----Review----- */}
            <Grid 
            ...
            >
                ...
                <Grid item lg style={{alignSelf: 'center'}}>
                    <img src={iterate} alt='falling dominoe' width='100%' />
                </Grid>
            </Grid>
            <Grid item>
