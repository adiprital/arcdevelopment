                ...
                >
                    ...
                    <Grid item className={classes.gridItem}>
                        <Grid container direction='column' spacing={2}>
                            ...
                            <Grid item component={Link} onClick={() => props.setValue(3)} to='/about' className={classes.link}>History</Grid> 
                            <Grid item component={Link} onClick={() => props.setValue(3)} to='/about' className={classes.link}>Team</Grid>  
                        </Grid>
                    </Grid>
                    <Grid item className={classes.gridItem}>
                        <Grid container direction='column' spacing={2}>
