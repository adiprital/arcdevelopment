...
const useStyles = makeStyles(theme => ({
    ...
    revolutionBackgroung: {
        backgroundImage: `url(${revolutionBackgroung})`,
...
export default function LandingPage(props) {
    ...
    const defaultOptions = {
        ...
        rendererSettings: {
            preserveAspectRario: 'xMidYMis slice'
        }
    };
        ...
        <Grid container direction='column' className={classes.mainContainer}>
                ...
                > 
                    <Grid item style={{marginLeft: matchesSM ? 0 : '5em', 
                        ...
                        <Typography variant='subtitle1'>
                            Complate digital solutions, from investigation to{' '}
                    ...
                    <Grid item>
                        <img className={classes.icon} alt='custom software icon' src={customSotwareIcon} />
                    </Grid>
                </Grid>
            </Grid>
            <Grid item>{' '} {/*-----iOS/Android Block----- */}
                ...
                > 
                    <Grid item style={{textAlign: matchesSM ? 'center' : undefined}}>
                        ...
                        <Typography variant='subtitle1' className={classes.subtitle}>
                            Extend Functionality. Extand Access. Increase Engagment.
                        </Typography>
                        <Typography variant='subtitle1'>
            ...
            <Grid item>{' '} {/*-----The Revolution Block----- */}
                <Grid container style={{height: '100em', marginTop: '12em'}} alignItems='center' justifyContent='center'>
                    ...
                    <div className={classes.revolutionBackgroung} />
                </Grid>
            </Grid>
